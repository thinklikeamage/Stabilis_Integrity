...
/**
 * Interface for all Stabilis Integrity source models
 *
 * @category    Stabilis
 * @package     Stabilis_Integrity
 * @author      Luke A. Leber <lukeleber@gmail.com>
 */
interface Stabilis_Integrity_Model_Source_Model_Interface 
    extends Stabilis_Core_Model_Source_Model_Interface {
